...
//	fi = max(0.0, fi - ((fl == 0.0) ? 0.001  : -fl * 0.002));
    ...
    fl = max(0.0, fl - ((minFl == 0.0) ? 0.002   : 0.001));
    fi = max(0.0, fi - ((fl == 0.0) ? 0.000005  : -fl * 0.00001));
    
//    fl = max(0.0, fl - ((minFl == 0.0) ? 0.000   : 0.000));
//    fi = max(0.0, fi - ((fl == 0.0) ? 0.00000  : -fl * 0.00000));
